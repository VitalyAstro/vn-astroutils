...
import numpy, pyfits, types, itertools, scipy.io, scipy.spatial.kdtree

from numpy import *
#from numpy import array, sin, cos, tan, pi, deg2rad, rad2deg, arctan2, arcsin
#from numpy import reshape, transpose, dot, sqrt, poly1d
#from numpy import zeros, arange, concatenate, ndarray
#from numpy import sinh, maximum, minimum
...
def dtdz(z, lambda0=None, q0=None):
   
   term1 = (1.0e0 + z)
   term2 = 2.0e0 * (q0 + lambda0) * z + 1.0e0 - lambda0
   term3 = (1.0e0 + z) * (1.0e0 + z)
...
#<JD> Julian date for the middle of exposure, -2400000
...
#
#EXAMPLE:
#		rv,hjd= helcorr(0.,0.,100.,5.7966667,28.583611,52942.70833,True)
#
