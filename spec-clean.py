#!/usr/bin/python
"""spec-aver: ver. 20221208  (c) Vitaly Neustroev"""
DateVer='1.01: 2022-Dec-08'
...
# ==============================================================================
def print_history():
    print('2022-Dec-08: Renamed from xs_clean_new.py and some minor changes applied.')
...
def print_header():
    ...
    print ("**                                  spec_clean.py                                   **")
    print ("**                             ver. %s                               **" % DateVer)
    print ("** A little utility to clean TXT-files of spectra from bad data points and outliers **")
    print ("**                                   2022-Dec-08                                    **")
